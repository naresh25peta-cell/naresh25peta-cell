...
I work across data science and AI engineering, from cleaning and modeling raw data to building production-shaped LLM applications.

**What I'm building:**
- [document-qa](https://github.com/naresh25peta-cell/document-qa) - a local RAG app with hybrid (keyword + semantic) search, source citations, and evaluation benchmarks
...
- Report what didn't work as clearly as what did, a 97% accuracy on an imbalanced dataset is not a win
- Write code and docs for someone other than me to pick up
- Prefer a working, testable pipeline over a polished single notebook

**Tools I use:**
- Languages/Data: Python, pandas, NumPy
- ML: scikit-learn, XGBoost, Random Forest
- LLM/Agents: LangChain, LangGraph, RAG, FAISS
- Backend/Infra: FastAPI, Streamlit, Docker, GitHub Actions
